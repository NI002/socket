...
class TCPServer {
    public static void main(String argv[]) throws Exception {
        ...
        System.out.println("Server is listening on port: " + argv[0] + " , and IP address: "
    ...
    private static void server(String[] argv, ServerSocket welcomeSocket) throws Exception {
        ...
        // set the starting directory to be seen by the client to the directory of the
        // server process
        ...
        try {
            ...
            System.out.println("A new client is now connected to your machine. Client IP address is : "
                    + connectionSocket.getInetAddress().toString());

            BufferedReader inFromClient = new BufferedReader(new InputStreamReader(connectionSocket.getInputStream()));
            DataOutputStream outToClient = new DataOutputStream(connectionSocket.getOutputStream());
            // DataOutputStream outToClient2 = new DataOutputStream(new
